...
export const DEMO_CREDENTIALS = [
  { email: 'admin@gainsocial.com', password: 'GainSocial2026', role: 'Admin' },
  { email: 'jasmine@gainsocial.com', password: 'password', role: 'Zone Lead' },
  { email: 'vendor@gainsocial.com', password: 'password', role: 'Vendor' },
];
